...
$(function () {
  ...
  var PFCloudmadeAttrib = 'Map data &copy; ' + new Date().getFullYear() + ' OpenStreetMap,';
  var PFCloudmade = new L.TileLayer(PFCloudmadeUrl, {maxZoom: 18, attribution: PFCloudmadeAttrib});
